...
const LoginPage = () => {
  return (
    <div className='flex items-center justify-center p-4 mt-5 md:px-20 xl:px-40'>
        <div className='bg-[#1e2333] p-10 flex md:w-[80%] lg:w-[50%] flex-col items-center justify-center gap-12 rounded-md text-white'>
